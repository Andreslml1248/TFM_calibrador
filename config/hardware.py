...
# ============================
KP_LOW: float = 0.005839963
KI_LOW: float = 0.00085361

KP_MID: float = 0.00323474
KI_MID: float = 0.00029108

KP_HIGH: float = 0.00323474
KI_HIGH: float = 0.00029108
...
MANUAL_STATIC_HOLD_DELAY_S: float = 0.5
